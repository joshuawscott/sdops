...
pdf.font("Helvetica")
#TODO: Select this based on the actual support levels
hw_desc = "Hardware Problem Diagnosis
...
sw_desc = "2 Hour Remote Response
7 Days/Week
24 Hours per Day
Patch Assistance
Assigned Software Engineer"			
pdf.table [[@contract.hw_support_level_id, hw_desc, @contract.sw_support_level_id, sw_desc]], {:font_size => 10, :border_width => 0, :row_height => 31, :column_widths => {0 => 120, 1 => 240, 2 => 120, 3 => 240}}
...
if multi_year_annual_option
  ...
  #banner
  pdf.table [["Option #{payment_option_number.to_s} (Includes Multi Year and PrePay Discounts)"]], :row_colors => ["F2F2F2"], :font_size => 12, :border_width => 0, :width => full_wide, :row_height => 18
  #row titles
  pdf.table [["","", "List\nPrice", "Discount\nRate", "Discount\nAmount", "Contract Price", ""]], {:font_size => 8, :align => :center, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.font("Helvetica", :size => 10)
  # data
  pdf.table [["Hardware Support Pricing","HW = 44%, Mult = 5%, PrePay = 4%", "$4,872.00", "53%", "$(2,582.16)", "$2,289.84", ""]], {:align => {0 => :left, 1 => :left, 2 => :right, 3 => :right, 4 => :right, 5 => :right, 6 => :right, 7 => :right}, :font_size => 10, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.table [["Software Support Pricing","SW = 44%, Mult = 5%, PrePay = 4%", "$4,872.00", "53%", "$(2,582.16)", "$2,289.84", ""]], {:align => {0 => :left, 1 => :left, 2 => :right, 3 => :right, 4 => :right, 5 => :right, 6 => :right, 7 => :right}, :font_size => 10, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.table [["Services Pricing","SW = 44%, Mult = 5%, PrePay = 4%", "$4,872.00", "53%", "$(2,582.16)", "$2,289.84", ""]], {:align => {0 => :left, 1 => :left, 2 => :right, 3 => :right, 4 => :right, 5 => :right, 6 => :right, 7 => :right}, :font_size => 10, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.move_down 7
end
...
if multi_year_monthly_option
  ...
  payment_option_number += 1
  #banner
  pdf.table [["Option #{payment_option_number.to_s} (Includes Multi Year Discount)"]], :row_colors => ["F2F2F2"], :font_size => 12, :border_width => 0, :width => full_wide, :row_height => 18
  #row titles
  pdf.table [["","", "List\nPrice", "Discount\nRate", "Discount\nAmount", "Contract Price", "Monthly Price"]], {:font_size => 8, :align => :center, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.font("Helvetica", :size => 10)
  # data
  pdf.table [["Hardware Support Pricing","HW = 44%, Mult = 5%, PrePay = 4%", "$4,872.00", "53%", "$(2,582.16)", "$2,289.84", "190.82"]], {:align => {0 => :left, 1 => :left, 2 => :right, 3 => :right, 4 => :right, 5 => :right, 6 => :right, 7 => :right}, :font_size => 10, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.table [["Software Support Pricing","SW = 44%, Mult = 5%, PrePay = 4%", "$4,872.00", "53%", "$(2,582.16)", "$2,289.84", "190.82"]], {:align => {0 => :left, 1 => :left, 2 => :right, 3 => :right, 4 => :right, 5 => :right, 6 => :right, 7 => :right}, :font_size => 10, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.table [["Services Pricing","SW = 44%, Mult = 5%, PrePay = 4%", "$4,872.00", "53%", "$(2,582.16)", "$2,289.84", "190.82"]], {:align => {0 => :left, 1 => :left, 2 => :right, 3 => :right, 4 => :right, 5 => :right, 6 => :right, 7 => :right}, :font_size => 10, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.move_down 7
end
...
if annual_option
  ...
  payment_option_number += 1
  #banner
  pdf.table [["Option #{payment_option_number.to_s} (Includes PrePay Discount)"]], :row_colors => ["F2F2F2"], :font_size => 12, :border_width => 0, :width => full_wide, :row_height => 18
  #row titles
  pdf.table [["","", "List\nPrice", "Discount\nRate", "Discount\nAmount", "Contract Price", ""]], {:font_size => 8, :align => :center, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.font("Helvetica", :size => 10)
  # data
...
if monthly_option
  ...
  payment_option_number += 1
  #banner
  pdf.table [["Option #{payment_option_number.to_s} (Includes Prefered Customer Discount Only)"]], :row_colors => ["F2F2F2"], :font_size => 12, :border_width => 0, :width => full_wide, :row_height => 18
  #row titles
  pdf.table [["","", "List\nPrice", "Discount\nRate", "Discount\nAmount", "Contract Price", "Monthly Price"]], {:font_size => 8, :align => :center, :column_widths => pod_widths, :border_width => 0, :vertical_padding => 0, :horizontal_padding => 0}
  pdf.font("Helvetica", :size => 10)
  # data
