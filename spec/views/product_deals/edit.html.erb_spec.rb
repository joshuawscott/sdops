...
describe "/product_deals/edit.html.erb" do
  ...
  it "should render edit form" do
    render "/product_deals/edit.html.erb"
    
    response.should have_tag("form[action=#{product_deal_path(@product_deal)}][method=post]") do
