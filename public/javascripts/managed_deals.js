...
function changeManagedDealAccount() {
  var account_id_dropdown = $('managed_deal_account_id');
  ...
  new Ajax.Request(requestURL, {
    ...
    onFailure: function(transport) {
      ...
      $('managed_deal_end_user_id').innerHTML = '';
    },
    onSuccess: function(transport){
      var end_users = transport.responseText.evalJSON(true);
      var end_user_dropdown = $('managed_deal_end_user_id');
